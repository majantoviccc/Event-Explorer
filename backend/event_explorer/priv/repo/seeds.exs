...
create_event.(%{
  ...
  price: "50",
  featured: false,
  image: "https://res.cloudinary.com/datqqcleg/image/upload/v1773918214/film-directors_k1huoa.png",
...
create_event.(%{
  ...
  price: "0",
  featured: false,
  image: "https://res.cloudinary.com/datqqcleg/image/upload/v1773918302/yoga-festival_xdbiuq.png",
...
create_event.(%{
  ...
  price: "70",
  featured: true,
  image: "https://res.cloudinary.com/datqqcleg/image/upload/v1773918212/cybersecurity-summit_pnwjml.png",
...
create_event.(%{
  ...
  price: "20",
  featured: false,
  image: "https://res.cloudinary.com/datqqcleg/image/upload/v1773918213/electronic-festival_a2fedq.png",
...
create_event.(%{
  ...
  price: "15",
  featured: true,
  image: "https://res.cloudinary.com/datqqcleg/image/upload/v1773918219/startup-pitch_xsvxkn.png",
...
create_event.(%{
  ...
  description: "The largest React conference bringing together developers from around the world.",
  date: ~D[2026-03-30],
  time: ~T[12:24:00],
  price: "20",
  featured: true,
  image: "https://res.cloudinary.com/datqqcleg/image/upload/v1775461424/Screenshot_2026-04-06_at_09.43.15_mfkaes.png",
...
create_event.(%{
  ...
  description: "Experience live graffiti, urban art, and street performances from talented artists.",
  date: ~D[2026-06-18],
  time: ~T[16:00:00],
  price: "30",
  featured: false,
  image: "https://res.cloudinary.com/datqqcleg/image/upload/v1775461333/Screenshot_2026-04-06_at_09.35.20_rwiai8.png",
  city_id: city_map["London"].id,
  venue_id: venue_map["Startup Hub"].id
}, ["Art","Lifestyle"])
...
create_event.(%{
  ...
  description: "Enjoy a premium selection of wines and culinary delights in a relaxing atmosphere.",
  date: ~D[2026-06-22],
  time: ~T[19:00:00],
  price: "60",
  featured: true,
  image: "https://res.cloudinary.com/datqqcleg/image/upload/v1775461316/Screenshot_2026-04-06_at_09.39.42_nkwdcy.png",
  city_id: city_map["Rome"].id,
  venue_id: venue_map["Central Square"].id
}, ["Food","Lifestyle"])
